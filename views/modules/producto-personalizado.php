  <div class="content-wrapper">
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Producto Personalizado</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <div class="row">
            <div class="col-md-3">
              <h3 class="box-title">Lista Productos Personalizados</h3>
            </div>
            <div class="col-md-9">
                ...
                <div class="row">
                  ...
                  <div class="col-md-2">
                    <div class="form-group form-group-sm tipoVista">
                      <select class="form-control" name="tipoVistaPP" id="tipoVistaPP">
                        <option value="1" selected>Cuadriculada</option>
        ...
        <div class="box-body">
          <div class="row">
            ...
            <div class="col-md-9">
                <div id="contendorProductoPersonalizado">
                  <div class="row">
                    <?php for($i=0;$i<3; $i++){?>
                    <div class="col-md-4">
                        ...
                        <div class="col_1_of_single1 span_1_of_single1">
                          <div class="view1 view-fifth1">
                            <div class="top_box">
                              <a href="#">
                                <div class="grid_img">
                                  <div class="css3"><img src="views/img/collar.jpg" width="250" alt=""/></div>
                                </div>
                              </a>
                              <p>Corona Angie</p>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header" style="background:#3c8dbc; color:white">
          ...
          <h4 class="modal-title">Agregar Nuevo Producto Personalizado</h4>
        </div>
          ...
          <div class="row">
            <div class="col-md-4">
              ...
              <div class="botonSubirImagen ">
                <button class="btn btn-primary">Subir Imagen Cotizable</button>
              </div>
            </div>
            <div class="col-md-8">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <div class="input-group btnSubirEPS">
                      <button class="btn btn-primary">Subir Imagen EPS</button>
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
